...
function TrafficViolationsPage() {
  ...
  const fetchBalance = async () => {
    try {
      ...
      const res = await axios.get(`https://project.dubaisi.net/api/user/${username}`);
  ...
  const fetchViolations = async () => {
    try {
      ...
      const res = await axios.get(`https://project.dubaisi.net/api/${username}/violations`);
  ...
  const confirmPayment = async () => {
    ...
    if (balance >= totalAmount) {
      ...
      try {
        const username = localStorage.getItem('username');
        const res = await axios.post('https://project.dubaisi.net/api/pay-violations', {
          username,
