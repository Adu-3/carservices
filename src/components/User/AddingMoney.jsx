...
const AddingMoney = () => {
  ...
  useEffect(() => {
    const fetchBalance = async () => {
      try {
        ...
        const response = await axios.get(`https://project.dubaisi.net/api/balance/${username}`);
  ...
  const handleAddMoney = async (e) => {
    ...
    try {
      ...
      await axios.post('https://project.dubaisi.net/api/validate-card', { // Absolute URL
      ...
      const response = await axios.post('https://project.dubaisi.net/api/update-balances', {
